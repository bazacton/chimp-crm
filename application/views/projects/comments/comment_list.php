...
foreach ($comments as $comment) {
    ...
    $comment_class  = '';
    if( $comment->created_by != $this->Users_model->login_user_id() ){
        $comment_class  = 'comment_class';
    }
    ?>
    <div class="media b-b mb15 <?php echo "comment-".$type; ?> <?php echo $comment_class; ?>">
