<div class="modal-body clearfix general-form ">
    ...
    <div class="form-group clearfix">
        ...
        <?php if ($model_info->task_hours) { ?>
            <div class="col-md-12 mb15">
                <strong><?php echo lang('task_hours') . ": "; ?></strong> <?php echo $model_info->task_hours; ?>
            </div>
        <?php } ?>
        <?php if ($model_info->task_price) { ?>
            <div class="col-md-12 mb15">
                <strong><?php echo lang('task_price') . ": "; ?></strong> <?php echo $model_info->task_price; ?>
            </div>
        <?php } ?>
    </div>
