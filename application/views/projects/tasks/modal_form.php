...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="title" class=" col-md-3"><?php echo lang('task_hours'); ?></label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "task_hours",
                "name" => "task_hours",
                "value" => $model_info->task_hours,
                "class" => "form-control",
                "placeholder" => lang('task_hours'),
                "autofocus" => true,
    ...
    <div class="form-group">
        <label for="title" class=" col-md-3"><?php echo lang('task_price'); ?></label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "task_price",
                "name" => "task_price",
                "value" => $model_info->task_price,
                "class" => "form-control",
                "placeholder" => lang('task_price'),
                "autofocus" => true,
                "data-rule-required" => false,
                "data-msg-required" => lang("field_required"),
            ));
