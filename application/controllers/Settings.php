...
class Settings extends Pre_loader {
    ...
    function save_general_settings() {
        $settings = array("site_logo", "invoice_logo", "app_title", "language", "timezone", "date_format", "time_format", "first_day_of_week", "default_currency", "currency_symbol", "decimal_separator", "accepted_file_formats", "rows_per_page", "item_purchase_code", "response_time");
    ...
    function save_client_settings() {
        $settings = array("disable_client_login_and_signup", "client_message_users", "client_can_create_tasks", "client_can_edit_tasks", "client_can_view_tasks", "client_can_comment_on_tasks", "client_can_view_project_files", "client_can_add_project_files", "client_can_comment_on_files");
